# Na aula anterior, você viu como utilizar mdays de calendar(que pega a quantidade de dias do mês) para pegar o último
# dia do mês. Isso pode não funcionar como esperado em ano bissexto. Você também pode utilizar a função monthrange de
# calendar para pegar o número do dia na semana(entre 0 - 6) e último dia do mês(entre 28 - 31), exemplo:
...
# O número do dia na semana vai de 0 a 6(segunda é 0, domingo é 6). Caso queira retornar apenas um valor, você pode
# fazer o desempacotamento, assim:
